...
/**
 * DmfacebookcfSearch represents the model behind the search form about `backend\models\Dmfacebookcf`.
 */
class DmfacebookcfSearch extends Dmfacebookcf
{
    /**
     * @inheritdoc
     */
