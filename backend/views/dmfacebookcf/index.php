...
/* @var $searchModel backend\models\DmfacebookcfSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Dmfacebookcfs';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="dmfacebookcf-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('Create Dmfacebookcf', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
