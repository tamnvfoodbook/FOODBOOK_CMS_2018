...
$gridColumns = [
    ...
    [
        'attribute' => 'dmmembershippoint',
        'value' => 'dmmembershippoint.EAT_COUNT',
        'label' => 'Số lần ăn',
    ],
    [
        'attribute' => 'dmmembershippoint.AMOUNT',
        'format'=>['decimal',0],
        'label' => 'Đã tiêu',
    ],
    [
        'attribute' => 'dmmembershippoint.POINT',
        'label' => 'Tích điểm',
    ],
    [
        'attribute' => 'dmmembershippoint.EAT_LAST_DATE',
        'label' => 'Lần cuối ăn',
        'value' => function ($model){
            return date(Yii::$app->params['DATE_FORMAT'],strtotime(@$model->dmmembershippoint->EAT_LAST_DATE));
        },
    ],

    [
        'value' => function ($model){
            $datetime1 = strtotime(date('Y-m-d', strtotime(@$model->dmmembershippoint->EAT_LAST_DATE)));
    ...
    [
        'attribute' => 'dmmembershippoint.ZALO_FOLLOW',
        'label' => 'Đã kết nối',
        'format' => 'raw',
        'value' => function ($model){
            $zaloId = "'".@$model->dmmembershippoint->ZALO_FOLLOW."'" ;
//            echo $zaloId;
            ...
            if(strlen(@$model->dmmembershippoint->ZALO_FOLLOW)> 1){
                echo strlen($model->dmmembershippoint->ZALO_FOLLOW);
                echo $model->dmmembershippoint->ZALO_FOLLOW;
                echo '<br>';
