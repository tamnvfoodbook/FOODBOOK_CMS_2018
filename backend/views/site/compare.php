...
<?= Html::beginForm(); ?>
    ...
    <?= Html::dropDownList('posOption','text',$arrayPos,['class'=> 'form-control']);?>
    <label>Lựa chọn tùy chỉnh</label>
        <select id="callbacks" tabindex="0" name="optionTime" class="form-control">
            <option value="manual">Tùy chỉnh</option>
            <option value="P0D">Hôm nay</option>
            <option value="P1D">Hôm qua</option>
            <!--<option value="P1W">Tuần trước</option>
            <option value="P1M">Tháng trước</option>-->
            <option value="P7D">7 ngày trước</option>
            <option value="P30D">30 ngày trước</option>
        </select>
    <div class="form-group">
        ...
        <br/>
        <?= Html::a('Xem', 'index.php?r=compare', [
