...
<div class="col-md-6 col-sm-6 col-lg-6 col-md-offset-3 col-sm-offset-3 col-lg-offset-3">
    <div class="box1 col-md-8  col-lg-6 col-sm-12">
        ...
        <div>
            <p class="footer-text">Bạn quên tài khoản ? <?=Html::a('Lấy lại mật khẩu','index.php?r=site/resetpassword',['class'=> 'sign-up'])?> </p>
            <p></p>
            <!--<p class=""><?/*=Html::a('Quên mật khẩu','index.php?r=site/setemail',['class'=> 'sign-up'])*/?> </p>-->
