            ...
            $.fn.smartCart = function(options) {
                ...
                return this.each(function() {
                    ...
                    function addCartItemDisplay(objProd,Quantity,newIndex){
                        ...
                        var elmCPTitle2 = $('<span>'+pPrice+'<br/> <span class="priceDown" id="discounthiddenField'+pIndex+'">(&darr;'+ pDiscount + ' %)</span></span>').addClass("col-md-2 no-padding");
                        var replaceDiscountWith  = $('<input name="disTem"'+ pIndex +' type="text" />');
...
//                            var pCurI = valueArray[3];
                    ...
                    function updateCartQuantity(idx,qty){
                        ...
                        $(productItem).attr("value",newPValue).attr('selected', true);
                        var prdTotal = getMoneyFormatted((pPrice * qty) - (pPrice*qty*(pDiscount/100)));
                        // Now go for updating the design
