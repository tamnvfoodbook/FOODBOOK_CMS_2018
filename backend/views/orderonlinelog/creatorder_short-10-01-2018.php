...
$this->registerJsFile('https://maps.googleapis.com/maps/api/js?key=AIzaSyCzIazzVxp1G56WZjQVi1bm9IPU4LJc3t8&libraries=places&language=vi', ['position' => \yii\web\View::POS_HEAD]);
...
$(document).ready(function(){
    ...
    $.fn.smartCart = function(options) {
        ...
        return this.each(function() {
            ...
            //Voucher code
            var elmVoucher = $('<div></div>').addClass("row col-md-12");
            var elmVoucherLabel = $('<label>'+labelVoucher+':</label>').addClass("col-md-5");
            var elmVoucherInputEl = $('<div></div>').addClass("col-md-3");
            var elmVoucherInput = $('<input></input>').addClass("form-control voucherTxt");
            ...
            elmVoucher.append(elmVoucherLabel).append(elmVoucherInputEl).append(elmVoucherCodeLabel).append(elmVoucherValue).append(elmVoucherCheckCode);
                            ...
                            $.each(value, function( keyDetail, valueItemId) {
                                ...
                                $('#comboQty'+key+valueItemId+'  :selected').each(function(){
                                    ...
                                    if(comboItemId){
                                        ...
                                        if(ots_price != null){
                                            var itemIdPre = valueItemId+'_*_'+ots_price+'_*_'+dataItemId[3]+'_*_'+0;
                                        }else{
                                            itemIdPre = valueItemId+'_*_'+dataItemId[4]+'_*_'+dataItemId[3]+'_*_'+0;
                                        }
