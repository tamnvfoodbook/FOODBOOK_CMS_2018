...
//            var elmInfo = $('<div></div>').addClass("scDetailOrder");
            ...
            var elmGroupContent = $('<div></div>').addClass('col-md-5 no-padding');
            var elmGroup = $('<div class="input-group"><input type="text" class="form-control" name="textPhone" value="<?= $phoneNumber ?>" id="textPhone" ><span class="input-group-btn"><button class="btn btn-default" id="checkPhone" type="button"><span class="glyphicon glyphicon-search"></span></button></span></div>');
            var elmBottomPhoneValue = $('<input name="textPhone" value="<?= $phoneNumber ?>" id="textPhone">').addClass("form-control  required");
            var elmGroupBtn= $('<spand><button class="btn btn-secondary" type="button">Go!</button></span>').addClass('input-groupinput-group-btn');
                        ...
                        success:function(result){
                            if(result != false){
                                ...
                                if (typeof obj.user_info != 'undefined'){
                                    ...
                                    if (typeof obj.order_online_history[0].to_address != 'undefined'){
