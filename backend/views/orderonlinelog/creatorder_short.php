...
//                        elmCategory.appendTo(checkboxEatWith);
                ...
                $('.eatWithCkb').change(function() {
                    if(this.checked) {
                        ...
                        var idckcb = $(this).attr('id');
                        $('#cbTpdetail'+idckcb).html('');
                    }
                });
...
//                                    console.log('#eatWith'+pIdx);
            ...
            function refreshCartValues(){
                ...
                // Tính thêm cả các phí dịch vụ bên ngoài
...
//                var total = getCookie("total");
                ...
                setCookie('total',sTotal,1); // Lưu lại tổng vào Cokice
...
$( document ).ready(function() {
    ...
    function initialize() {
        ...
        // Create the search box and link it to the UI elemdmpoent.
        var input = document.getElementById('pac-input');
        var searchBox = new google.maps.places.SearchBox(input);
        map.controls[google.maps.ControlPosition.TOP_LEFT].push(input);

        // Bias the SearchBox results towards current map's viewpdmort.
