...
$infomation =
    '<span class="label-detail label label-success">HOÀN THÀNH '.count($complete).'</span>'
    .'<span class="label-detail label label-primary">NHÀ HÀNG ĐÃ NHẬN '.count($comfirmed).'</span>'
    .'<span class="label-detail label label-danger">ĐÃ HỦY '.count($cancelled).'</span>'
    .'<span class="label-detail label label-danger">THẤT BẠI '.count($failed).'</span>'
    .'<span class="label-detail label label-warning">CHỜ XÁC NHẬN '.count($wait_confirm).'</span>'
    .'<span class="label-detail label label-warning">TÌM XẾ '.count($assigning).'</span>'
    .'<span class="label-detail label label-warning">XẾ ĐÃ NHẬN '.count($accepted).'</span>'
    .'<span class="label-detail label label-warning">XẾ ĐANG GIAO HÀNG '.count($in_process).'</span>'
;
...
<?= GridView::widget([
    ...
    'panel' => [
        ...
        'heading' => '<h3 class="panel-title">'.$infomation.'</h3>',
    ],
    'toolbar' => [
        [
            'content'=>
