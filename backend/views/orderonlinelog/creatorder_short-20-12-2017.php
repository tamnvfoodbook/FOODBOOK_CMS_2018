...
//                    var countProductItem = elmProductSelected.children().length;
            ...
            function addToCartNomal(itemId,qty,packetId){
            ...
            function popupComboExtra(combo,comboItemId){
                ...
                $.each(combo, function( key, value ){
                    ...
                    $.each(itemArray, function( keyItem, itemId ){
                        ...
                        var inputQty = $('<select></select>').attr("id","comboQty"+tmpGroup+itemId ).attr("name","comboQty").attr("groupid",tmpGroup).attr("groupmax",value.quantity).attr("comboid",itemComboDetail[0]).addClass("form-control");
                            ...
                            $.each(value, function( keyDetail, valueItemId) {
                                ...
                                $('#comboQty'+key+valueItemId+'  :selected').each(function(){
                                    ...
                                    if(comboItemId){
                                        ...
                                        var itemIdPre = valueItemId+'_*_'+dataItemId[1]+'_*_'+dataItemId[3];
                                        if(qTycb > 0){
