                    ...
                    if(jQuery.inArray(value.Item_Id, arrEatWith) != -1) {
                        ...
                        if(value.combo_details != undefined){
                            if(checkedItem !== ''){
                                ...
                                '<input type="checkbox" name="eatWith" class="eatWithCkb" comboitems='+value.combo_details+' comboqty="'+value.quantity+'" comboid="" parentid="'+ idx +'" id="'+value.Id+'"  value="'+valueCombo+'" '+checkedItem+'/>' +
...
//                var ots_price = element.attr("ots_price");
                            ...
                            if(qTycb > 0){
                                groupCombo.push(itemId+'_*_'+ots_price+'_*_'+ctpname+'_*_'+qTycb+'_*_'+0 +'_*_'+combo_id); // 0 là Mã Món 1 là
