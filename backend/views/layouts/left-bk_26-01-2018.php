...
if ($type!= 1) {?>
    ...
    <ul class="sidebar-menu">
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <!--<li><a href="<?/*= \yii\helpers\Url::to(['/coupon']) */?>"><span class="fa fa-circle-o"></span>Tạo Coupon</a></li>
                <li><a href="<?/*= \yii\helpers\Url::to(['/couponlog']) */?>"><span class="fa fa-circle-o"></span> Coupon Log</a></li>
