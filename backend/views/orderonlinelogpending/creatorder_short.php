...
//            var elmFoodbookVoucherCode = $('<input name="coupon_log_id" value="<?//= @$model->coupon_log_id ?>//" type="hidden">');
            ...
            elmShowPayment.append(elmBottomNoteText).append(elmBottomNoteValueDiv).append(elmIdpending).append(elmFoodbookCode).append(elmFoodbookVoucherCode).append(elmCreatby);
