...
$this->title = 'Doanh số chi nhánh theo thời gian';
?>
    ...
    <script type="text/javascript">
        function loadChart(arr,name,div_id){
            ...
            function drawChart(){
                ...
                <?php
                    foreach($posNameRate as $key => $value){?>
                data.addColumn('number','<?php echo  (string)$value['POS_NAME'];?>'); // Implicit series 1 data col.
    ...
    <div style="padding-bottom: 1%;">
        <?= Html::button( 'Tất cả',['class' => 'btn btn-success','id' => 'btnAll']); ?>
        <?= Html::button( 'Xem Top' ,['class' => 'btn btn-success','onclick' => 'popupTopFunction();']); ?>
        <?= Html::button( 'Xem Bottom' ,['class' => 'btn btn-success','onclick' => 'popupBottomFunction();']); ?>
        <?= Html::button( 'Xem theo thời gian' ,['class' => 'btn btn-success','id' => 'buttonTimeDetail']); ?>
        <?= Html::button( 'So sánh' ,['class' => 'btn btn-success','id' => 'buttonCompareDetail']); ?>
        <p id="topdiv" style="float: right; margin-right: 5%;">
            <?php
            echo 'Chọn xem Top:';
        ...
        <p id="bottomdiv" style="float: right; margin-right: 5%;">
            <?php
            echo 'Chọn xem Bottom:';
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    <div class="inner">
                        ...
                        <p>Rating bình quân: <?php
                            if($oderRateSorted){
                                echo round((float)($scoreRate/count($oderRateSorted)),2);
                            }else{
                                echo 0;
                            }
                            ?> điểm</p>
...
<?= $this->render('../site/comparetwoposform', [
    'model' => $model,
]) ?>
<?php echo '</div>';
Modal::end();
...
echo '<div><div id="timeContent">';?>
<?= $this->render('../site/compare', [
    'model' => $model,
]) ?>
<?php echo '</div></div>';
Modal::end();
