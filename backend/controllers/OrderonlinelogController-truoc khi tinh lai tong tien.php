...
//        $dataProvider->setPagination(false);
    ...
    public function actionView($id)
    {
        ...
        if(@$model->voucher['discount_type']){
            ...
            if($model->voucher['discount_type'] == 2){
                $discountVoucher = $model->voucher['discount_extra']*$model->amount;
            }else{
                $discountVoucher = $model->voucher['discount_amount'];
            }
                ...
                foreach($post['products_selected'] as $product){
                    ...
                    foreach($itemList->data->list_item as $item){
                        if($item->Id == $proArray[0]){
                            ...
                            if(isset($proArray[8]) && @$proArray[8] != 'null' &&  @$proArray[8] != 'undefined'){
